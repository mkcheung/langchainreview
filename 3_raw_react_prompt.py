...
### Change: Remove JSON schemas - Tools will now live within the prompt as plain text/
### Descriptions will be derived from the functions themselves using inspect.
tools = {
...
def run_agent(question:str):
    ...
    for iteration in range(1, MAX_INTERATIONS + 1):
        ...
        if final_answer_match:
            ...
            print(f"    [Parsing] Final Answer: {final_answer}")
            print("\n" + "=" * 60)
